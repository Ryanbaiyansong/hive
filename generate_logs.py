...
def read_options():
    ...
    parser.add_option("-f", "--logfile", dest="logfile", help="Specify a log file. Default=/home/ec2-user/eventlog-demo.log", default="/home/ec2-user/eventlog-demo.log", type="string")
